...
public class EnseignantBuisinessImpl implements IEnseignantBuisiness {
	...
	public List<Enseignant> getEnseignants() {
		...
		/*Enseignant e1 = new Enseignant(1, 125, "Dupont", "Marc","1980-05-10" , "M", "Pr", "1990-09-01");
		Enseignant e2 = new Enseignant(2, 80, "Boyer", "Julie","1986-12-12" , "F", "MCF", "2005-09-01");
		Enseignant e3 = new Enseignant(3, 12, "Vincent", "Paul","1975-02-19" , "M", "Ass", "1999-09-01");
		Enseignant e4 = new Enseignant(4, 20, "Simon", "Etienne","1985-12-12" , "M", "MCF", "2006-03-12");
		
		listeEnseignants.add(e1);
		listeEnseignants.add(e2);
		listeEnseignants.add(e3);
	...
	public Enseignant getEnseignant(Integer id) {
		...
		for (int i = 0; i < listeEnseignants.size(); i++) {
			Enseignant en =listeEnseignants.get(i); 
			if(en.getId() == id) {
				e = listeEnseignants.get(i);
			}
		}*/	
	...
	public void saveEnseignant(Enseignant enseignant) {
		...
		/*
		System.out.println("Enseignant sauvegardé :");
		System.out.println("ID : " + enseignant.getId());
		System.out.println("Numéro Enseignant : " + enseignant.getNumEnseignant());
		System.out.println("Nom : " + enseignant.getNom());
		System.out.println("Prenom : " + enseignant.getPrenom());
		System.out.println("Date de naissance : " + enseignant.getDateNaissance());
		System.out.println("Sexe : " + enseignant.getSexe());
		System.out.println("Grade : " + enseignant.getGrade());
		System.out.println("Date d'embauche : " + enseignant.getDateEmbauche());
		*/
		// TODO Auto-generated method stub
